...
//实例化SharedPreferences.Editor对象（第二步）
        ...
        latback=Double.parseDouble(mySharedPreferences.getString("latback",""));//求救者经度
        lonback=Double.parseDouble(mySharedPreferences.getString("lonback",""));//求救者纬度
        initLocation();
        //开始定位
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MapActivity.this, FirstActivity.class);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MapActivity.this, FourthActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void setMarker() {
        ...
        LatLng point1 = new LatLng(latback, lonback);
        //构建Marker图标
